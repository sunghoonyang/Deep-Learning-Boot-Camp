...
class SimpleNet(nn.Module):
    def __init__(self, num_classes=1, n_dim=3):
        ...
        self.cnn1 = ConvCNN (n_dim,128,  kernel_size=7, pool=4, avg=False)
        self.cnn2 = ConvCNN (128,256, kernel_size=5, pool=2, avg=True)
        self.cnn3 = ConvCNN (256,128, kernel_size=5, pool=2, avg=True)

        self.res1 = ConvRes (128,64)
        ...
        self.classifier = torch.nn.Sequential(
            # nn.Linear(1280, (num_classes)), # TF
            nn.Linear(2304, (num_classes)),# two classes
        )
